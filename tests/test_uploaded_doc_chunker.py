...
def test_extract_txt_smoke():
    text, is_scanned, _, _pages, _conf = extract_txt(UGOVOR_TXT)
...
def test_extract_docx_smoke():
    text, is_scanned, _, _pages, _conf = extract_docx(UGOVOR_DOCX)
...
def test_chunker_recursive_mode():
    text, is_scanned, _, _pages, _conf = extract_txt(NO_ARTICLES_TXT)
