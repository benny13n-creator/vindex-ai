...
LAW_HINTS = {
    ...
    # ZDI — razmena/barter digitalne imovine (čl. 2, 91 ZDI; čl. 557 ZOO)
    # NAPOMENA: LAW_HINTS je hard Pinecone filter — rutiraj na ZDI (lex specialis),
    # agentski odgovor mora obuhvatiti i ZOO čl. 557 i ZDP iz sopstvenog znanja.
    "razmena digitalne imovine":      "zakon o digitalnoj imovini",
    "zamena digitalne imovine":       "zakon o digitalnoj imovini",
    "sredstvo razmene kripto":        "zakon o digitalnoj imovini",
    "sredstvo razmene digital":       "zakon o digitalnoj imovini",
    "barter kripto":                  "zakon o digitalnoj imovini",
    "barter digital":                 "zakon o digitalnoj imovini",
    "digitalna imovina za robu":      "zakon o digitalnoj imovini",
    "digitalna imovina za uslug":     "zakon o digitalnoj imovini",
    "robu za digitalnu imovinu":      "zakon o digitalnoj imovini",
    "uslug za digitalnu imovinu":     "zakon o digitalnoj imovini",
    "prihvatanje digitalne imovine":  "zakon o digitalnoj imovini",
    "placanje digitalnom imovinom":   "zakon o digitalnoj imovini",
    "zabrana placanja kripto":        "zakon o digitalnoj imovini",
    "zakonsko sredstvo placanja":     "zakon o digitalnoj imovini",
    "kompanija iz inostranstva kripto": "zakon o digitalnoj imovini",
    "inostranstvo digitalna imovina": "zakon o digitalnoj imovini",
